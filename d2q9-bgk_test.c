    ...
    for (int ii = start; ii < end; ii += increment)
    {
      ...
      ** scratch space grid */
      ...
      /* don't consider occupied cells */
        ...
        //DONE AV_VELOCITY
        tmp_cells->speeds[0][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[0][ii + jj*params.nx] : tmp_cells->speeds[0][ii + jj*params.nx];
        tmp_cells->speeds[1][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[3][x_e + jj*params.nx] : tmp_cells->speeds[1][ii + jj*params.nx];
        tmp_cells->speeds[2][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[4][ii + y_n*params.nx] : tmp_cells->speeds[2][ii + jj*params.nx];
        tmp_cells->speeds[3][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[1][x_w + jj*params.nx] : tmp_cells->speeds[3][ii + jj*params.nx];
        tmp_cells->speeds[4][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[2][ii + y_s*params.nx] : tmp_cells->speeds[4][ii + jj*params.nx];
        tmp_cells->speeds[5][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[7][x_e + y_n*params.nx] : tmp_cells->speeds[5][ii + jj*params.nx];
        tmp_cells->speeds[6][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[8][x_w + y_n*params.nx] : tmp_cells->speeds[6][ii + jj*params.nx];
        tmp_cells->speeds[7][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[5][x_w + y_s*params.nx] : tmp_cells->speeds[7][ii + jj*params.nx];
        tmp_cells->speeds[8][ii + jj*params.nx] = (obstacles[jj*params.nx + ii]) ? cells->speeds[6][x_e + y_s*params.nx] : tmp_cells->speeds[8][ii + jj*params.nx];
